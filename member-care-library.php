    ...
    <div class="page">
        ...
        <section class="hero">
            ...
            <div class="card">
                ...
                <div class="quick-grid">
                    ...
                    <a class="quick-link" href="member-care-library.php">
                        <div class="quick-title">Care Library</div>
                        <div class="quick-text">Browse feeding guidance, training tips, enrichment ideas, seasonal care, and premium member resources.</div>
                    </a>

                    <a class="quick-link" href="member-care-article.php">
                        <div class="quick-title">Featured Guide</div>
                        <div class="quick-text">Open the current featured article directly for thoughtful, premium care guidance and practical dog-care support.</div>
                    </a>
        ...
        <footer class="footer">
            ...
            <div class="footer-links">
                ...
                <a class="footer-link" href="member-care-library.php">Care Library</a>
