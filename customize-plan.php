...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $monthlyTotal =
        ($walks15 * $rates['walks_15']) +
        ($walks20 * $rates['walks_20']) +
        ($walks30 * $rates['walks_30']) +
        ($walks45 * $rates['walks_45']) +
        ($walks60 * $rates['walks_60']) +
        ($daycareDays * $rates['daycare_days']) +
        ($boardingSmall * $rates['boarding_small']) +
        ($boardingMedium * $rates['boarding_medium']) +
        ($boardingLarge * $rates['boarding_large']) +
        ($dropIns * $rates['drop_ins']);
    ...
    <section class="plan-grid">
      ...
      <div class="plan-card">
        ...
        <form method="post" action="" id="planForm">
          ...
          <div class="rate-row">
            <div><strong>15 Minute Walks</strong><span>Quick relief and short support visits</span></div>
            <input type="number" min="0" name="walks_15" id="walks_15" value="<?= e((string)$walks15) ?>">
            <div class="rate-price">$18 each</div>
          </div>

          <div class="rate-row">
            <div><strong>20 Minute Walks</strong><span>Short daily care and routine support</span></div>
            <input type="number" min="0" name="walks_20" id="walks_20" value="<?= e((string)$walks20) ?>">
            <div class="rate-price">$20 each</div>
          </div>

          <div class="rate-row">
            <div><strong>30 Minute Walks</strong><span>Balanced exercise and stimulation</span></div>
            <input type="number" min="0" name="walks_30" id="walks_30" value="<?= e((string)$walks30) ?>">
            <div class="rate-price">$25 each</div>
          </div>

          <div class="rate-row">
            <div><strong>45 Minute Walks</strong><span>Extended walk for higher energy dogs</span></div>
            <input type="number" min="0" name="walks_45" id="walks_45" value="<?= e((string)$walks45) ?>">
            <div class="rate-price">$31 each</div>
          </div>

          <div class="rate-row">
            <div><strong>60 Minute Walks</strong><span>Premium full-hour walk experience</span></div>
            <input type="number" min="0" name="walks_60" id="walks_60" value="<?= e((string)$walks60) ?>">
            <div class="rate-price">$34 each</div>
          </div>

          <div class="section-label">Additional Services</div>

          <div class="rate-row">
            <div><strong>Daycare Days</strong><span>Structured daytime care</span></div>
            <input type="number" min="0" name="daycare_days" id="daycare_days" value="<?= e((string)$daycareDays) ?>">
            <div class="rate-price">$45 each</div>
          </div>

          <div class="rate-row">
            <div><strong>Boarding Nights — Small Dog</strong><span>Overnight care for small dogs</span></div>
            <input type="number" min="0" name="boarding_small" id="boarding_small" value="<?= e((string)$boardingSmall) ?>">
            <div class="rate-price">$80 each</div>
          </div>

          <div class="rate-row">
            <div><strong>Boarding Nights — Medium Dog</strong><span>Overnight care for medium dogs</span></div>
            <input type="number" min="0" name="boarding_medium" id="boarding_medium" value="<?= e((string)$boardingMedium) ?>">
            <div class="rate-price">$100 each</div>
          </div>

          <div class="rate-row">
            <div><strong>Boarding Nights — Large Dog</strong><span>Overnight care for large dogs</span></div>
            <input type="number" min="0" name="boarding_large" id="boarding_large" value="<?= e((string)$boardingLarge) ?>">
            <div class="rate-price">$120 each</div>
          </div>

          <div class="rate-row">
            <div><strong>Drop-In Visits</strong><span>30 minute visit for check-ins and care</span></div>
            <input type="number" min="0" name="drop_ins" id="drop_ins" value="<?= e((string)$dropIns) ?>">
            <div class="rate-price">$20 each</div>
          </div>
          ...
          <div class="payment-choice">
            <label class="payment-option">
              ...
              <p>Save and continue to the payment portal immediately.</p>
            </label>
            ...
            <label class="payment-option">
              ...
              <p>Continue to choose whether you want to pay now or later.</p>
            </label>
          </div>
      ...
      <div class="plan-card">
        <div class="summary-box">
          ...
          <div>Estimated monthly total based on the services selected.</div>
...
const labels = {
  ...
  drop_ins: 'Drop-In Visits (30 Min)'
};
