...
/**
 * Doggie Dorian's
 * admin-enable-worker.php
 *
 * Stable admin-only worker enable page.
 */
...
$alreadyActive = worker_is_active($worker);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        if ($updates === []) {
            $error = 'No enable-related status columns were found in the users table.';
        } else {
        ...
        $error = 'Could not enable worker: ' . $e->getMessage();
    }
}
?>
<!DOCTYPE html>
        ...
        <section class="panel">
            ...
            <div class="summary">
                ...
                <div class="box">
                    ...
                    <div class="value"><?= $alreadyActive ? 'Active' : 'Disabled' ?></div>
                </div>
            </div>
